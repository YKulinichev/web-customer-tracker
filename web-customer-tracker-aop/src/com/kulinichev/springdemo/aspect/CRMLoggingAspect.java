package com.kulinichev.springdemo.aspect;
...
//setup pointcut declaration
	...
	@Pointcut("execution(* com.kulinichev.springdemo.controller.*.*(..))")
	private void forControllerPackage() {
		
	}
	
	//pointcut from service and DAO
	@Pointcut("execution(* com.kulinichev.springdemo.service.*.*(..))")
	private void forServicePackage() {
		
	}
	
	@Pointcut("execution(* com.kulinichev.springdemo.dao.*.*(..))")
